  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-brand-blue/20 rounded-full blur-[120px] mix-blend-screen opacity-50 animate-pulse" />
        <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] bg-brand-gold/10 rounded-full blur-[100px] mix-blend-screen opacity-50" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-8 items-center">
        ...
        <div className="flex flex-col items-start pt-12 lg:pt-0">
          ...
          >
            ...
            <span className="text-brand-gold text-[10px] font-bold uppercase tracking-[0.3em]">Africa's Elite SEO Growth Agency</span>
          </motion.div>
          ...
          >
            <a
              href="#contact"
              className="group relative px-8 py-4 bg-brand-gold text-brand-black font-bold uppercase text-xs tracking-widest flex items-center justify-center"
            >
            ...
            >
              Get Growth Strategy <span className="text-brand-blue">→</span>
            </a>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-brand-charcoal border-l border-white/10 relative p-8 md:p-12 w-full max-w-lg flex flex-col justify-between h-full min-h-[500px]">
            {/* Ambient Glow */}
            <div className="absolute top-1/4 right-0 w-64 h-64 bg-brand-blue/10 blur-[100px] rounded-full pointer-events-none"></div>
            <div className="absolute bottom-1/4 left-0 w-48 h-48 bg-brand-gold/10 blur-[80px] rounded-full pointer-events-none"></div>

            {/* Metric Cards */}
            <div className="space-y-6 relative z-10 w-full mb-12">
              <div className="glass-panel p-6">
                <div className="text-brand-gold text-sm font-bold mb-1">+430%</div>
              ...
              <div className="glass-panel p-6">
                <div className="text-brand-blue text-sm font-bold mb-1 uppercase tracking-widest">#1 Rankings</div>
                <div className="text-2xl font-light tracking-tight">Global Search Authority</div>
                <div className="flex items-end gap-1 mt-4 h-14">
                  <div className="w-2 h-8 bg-brand-blue/40"></div>
                  <div className="w-2 h-10 bg-brand-blue/60"></div>
                  <div className="w-2 h-12 bg-brand-blue"></div>
                  <div className="w-2 h-6 bg-brand-blue/30"></div>
                  <div className="w-2 h-14 bg-brand-blue"></div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 mt-auto">
              ...
              <p className="italic text-lg text-white/80 leading-snug mb-4">
